...
<plan-tasks plan="13" plan-version="plan-13-v1">
  ...
  <task id="2" risk="low" status="agent-coded">
    <name>Task two</name>
    <commit>abc1234</commit>
    <created-from>plan-13-v1</created-from>
    <closed-at-version>plan-13-v2</closed-at-version>
    <comments>
      <comment timestamp="2026-04-10T12:00:00.000Z">First comment</comment>
    </comments>
    <deviations>
      <deviation type="minor" timestamp="2026-04-10T13:00:00.000Z">Split task</deviation>
    </deviations>
  </task>
  </tasks>
  ...
  <project-updates>
    ...
    <update timestamp="2026-04-10T14:00:00.000Z" blocked="true">Blocked on review.</update>
  </project-updates>
</plan-tasks>
`;

const EMPTY_COLLECTIONS_XML = `<?xml version="1.0" encoding="UTF-8"?>
<plan-tasks plan="5" plan-version="plan-5-v1">
  <metadata>
  ...
  <tasks>
  <task id="1" risk="medium" status="pending">
    <name>Only task</name>
    <commit></commit>
  ...
  <project-updates>
    <update timestamp="2026-04-01T09:00:00.000Z">Init.</update>
  </project-updates>
</plan-tasks>
`;
...
test('parsePlanXml reads tasks array with attributes', () => {
  const plan = parsePlanXml(SAMPLE_XML);
...
test('serializePlanXml round-trip preserves tasks with attributes', () => {
  const plan = parsePlanXml(SAMPLE_XML);
  const xml2 = serializePlanXml(plan);
  const plan2 = parsePlanXml(xml2);
